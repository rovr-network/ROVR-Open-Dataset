...
POINT_CLOUD_REGISTER_POINT_STRUCT(rovr::Point,
  (float, x, x)(float, y, y)(float, z, z)
  (double, intensity, intensity)(uint32_t, index, index)
  (uint16_t, ring, ring)(double, timestamp, timestamp)
)
POINT_CLOUD_REGISTER_POINT_STRUCT(rovr::PointXYZIT,
  (float, x, x)(float, y, y)(float, z, z)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(rslidar_ros::Point,
                                  (float, x, x)(float, y, y)(float, z, z)(double, intensity, intensity)(uint16_t, ring, ring)(double, timestamp, timestamp))
...
private:
  ...
  void rsm1_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg);
